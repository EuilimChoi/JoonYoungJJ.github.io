...
Front Matter, Profile, Site 에 대한 내용을 Html로 변환하고 웹 피드를 생성한다. (RSS 피드 형식 아님) Front Matter는 이전에 작성해 둔 [블로그 관리 1]({{ site.url }}/blog/1)을 참고하면 된다.  

- [jekyll-feed repository](https://github.com/jekyll/jekyll-feed)  
...
다음 플러그인은 minimal-mistakes 테마에서 사용시 에러가 발생되는 것을 확인하였습니다 > jekyll-auto-image, jekyll-assets
{: .notice--danger}  
