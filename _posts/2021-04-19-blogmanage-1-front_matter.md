...
{% include figure image_path="[/assets/images/unsplash-image-10.jpg](https://devopedia.org/images/article/78/1631.1525880749.png)" alt="Static Site Generator" caption="Static Site Generator by. DEVOPEDIA" %}
<!-- ![Static Site Generator](https://devopedia.org/images/article/78/1631.1525880749.png)  
[DEVOPEDIA](https://devopedia.org/static-site-generators) 에서 스크랩
{: .text-center}   -->
